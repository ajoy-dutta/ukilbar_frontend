...
const WelfareExpanse = () => {
  ...
  const fetchPercentageConfig = async () => {
    try {
      const res = await AxiosInstance.get("welfare-expense-category/");
  ...
  return (
    <div className="">
      <h2 className="text-2xl font-semibold mb-4">Welfare Expense Report</h2>
